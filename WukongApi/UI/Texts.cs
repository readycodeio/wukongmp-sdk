namespace WukongApi.UI
{
    ...
    {
        public const string InMultiplayer = "In Multiplayer Lobby";
        public const string PressToBeReady = "Press J to be ready";
        public const string PressToPlayWithBots = "Press I to play with bots";
        public const string PressToBeNotReady = "Press J to be not ready";
        public const string PressToCancelMatch = "Press I to cancel match";
        ...
        public const string WaitForEnd = "Wait for the match to end";
