    ...
    public class Mod : ICSharpMod
    {
        ...
        public void Init()
        {
            ...
            Utils.RegisterKeyBind(ModifierKeys.Alt, Key.J, () =>
            {
                ...
                WukongMP.Instance.ApplyPlayerMontageCallback(new MontageCallbackData(WukongMP.Instance.Client.LocalPlayerState.PhotonId, true, "Player/Wukong/AM/Attack/ComboB/AM_wukong_combob_z_02_weak", 0f, false));
            });
            
            Utils.RegisterKeyBind(ModifierKeys.Alt, Key.K, () =>
            {
                Logging.LogDebug("Alt + K");
                WukongMP.Instance.ApplyPlayerMontageCallback(new MontageCallbackData(WukongMP.Instance.Client.LocalPlayerState.PhotonId, true, "Player/Wukong/AM/Attack/ComboB/AM_wukong_combob_z_02", 0f, false));
            });
#endif
