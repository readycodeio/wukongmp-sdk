    ...
    public class Mod : ICSharpModEx
    {
        ...
        public void Init()
        {
            ...
            Utils.RegisterKeyBind(ModifierKeys.Alt, Key.J, () =>
            {
                ...
                WukongMpMod.Instance.OnMontageCallback(new MontageCallbackData(NetworkIdComponent.FromPlayerPeerId(WukongMpMod.Client.LocalPlayerState.PeerId), true, "Player/Wukong/AM/Attack/ComboB/AM_wukong_combob_z_02_weak", 0f, false));
            });

            Utils.RegisterKeyBind(ModifierKeys.Alt, Key.K, () =>
            {
                Logging.LogDebug("Alt + K");
                WukongMpMod.Instance.OnMontageCallback(new MontageCallbackData(NetworkIdComponent.FromPlayerPeerId(WukongMpMod.Client.LocalPlayerState.PeerId), true, "Player/Wukong/AM/Attack/ComboB/AM_wukong_combob_z_02", 0f, false));
            });
#endif
