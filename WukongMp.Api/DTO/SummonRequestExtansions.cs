...
{
    public static class SummonRequestExtansions
    {
        public static FServantReq ToGame(this SummonRequestData value)
        {
            ...
            //UAnimMontage bornMontage = preloadAssetMgr.TryGetCachedResourceObj<UAnimMontage>(value.BornMontagePath, ELoadResourceType.SyncLoadAndCache);
        ...
        public static SummonRequestData FromGame(this FServantReq value)
        {
            ...
            //var equipment = new EquipmentState(value.MapEquip.Select(kvp => (kvp.Key.FromGame(), kvp.Value)));
