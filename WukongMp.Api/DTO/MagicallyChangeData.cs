...
public partial struct MagicallyChangeData(string configAssetName, bool compressed, int skillID, int recoverSkillID, int curVigorSkillID, ECastReason_MagicallyChange castReason) : INetSerializable
{
