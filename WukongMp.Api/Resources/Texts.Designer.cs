...
namespace WukongMp.Api.Resources {
    ...
    internal class Texts {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Only room owner can use {0}.
        /// </summary>
        internal static string OnlyRoomOwnerCanUse {
            get {
                return ResourceManager.GetString("OnlyRoomOwnerCanUse", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Set monster HP scaling: {0}x.
        /// </summary>
        internal static string SetMonsterHpScaling {
            get {
                return ResourceManager.GetString("SetMonsterHpScaling", resourceCulture);
            }
        }
