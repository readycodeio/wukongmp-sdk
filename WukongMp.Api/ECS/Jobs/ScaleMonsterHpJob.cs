...
public readonly struct ScaleMonsterHpJob(int scaling) : IEach<HpComponent, LocalTamerComponent>
{
    public void Execute(ref HpComponent hp, ref LocalTamerComponent tamer)
    {
        hp.HpMult = scaling;
