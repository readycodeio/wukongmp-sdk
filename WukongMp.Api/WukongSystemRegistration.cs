...
internal sealed class WukongSystemRegistration : IDisposable
{
    private readonly SystemGroup _syncGroup;
    private readonly IClientEcsUpdateLoop _ecsLoop;

    public WukongSystemRegistration(
        ...
        ILogger logger)
    {
        ...
        _syncGroup = new SystemGroup("Synchronization")
        {
        ...
        _ecsLoop.AddSystem(_syncGroup);
    }

    public void Dispose()
    {
        _ecsLoop.RemoveSystem(_syncGroup);
    }
}