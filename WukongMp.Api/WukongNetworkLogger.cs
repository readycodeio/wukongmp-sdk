...
)
{
    public void DumpDebugInfo()
    {
        ...
        world.Query<MetadataComponent>().ForEachEntity((ref metaComp, entity) => { logger.LogDebug("Entity {NetId} (owner {Owner}): {Entity}", metaComp.NetId, metaComp.Owner, entity.DebugJSON); });
